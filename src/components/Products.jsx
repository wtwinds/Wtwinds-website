export default function Products() {
  const products = [
    ...
    { name: "HR Appraisal", icon: "bi-clipboard-check", color: "text-warning", link: "https://hr-appraisal-o1ig.onrender.com" },
    ...
    { name: "LinkedIn AI", icon: "bi-linkedin", color: "text-primary", link: "https://linkedin-f12b.onrender.com" },
     { name: "Helmet Rental", icon: "bi-shield-check", color: "text-secondary", link: "https://helmet-rental-p8w8.onrender.com" },
    { name: "Cab Booking", icon: "bi-car-front", color: "text-info", link: "https://cab-booking-p0v6.onrender.com" },
    ...
    { name: "Fly Track", icon: "bi-airplane", color: "text-info", link: "https://fly-track.onrender.com" },
     { name: "HealTrack", icon: "bi-heart-pulse", color: "text-danger", link: "https://healtrack-1-h3ye.onrender.com" },
  ];
